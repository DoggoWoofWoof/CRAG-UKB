...
def required_inputs(task_name: str, argv: List[str]) -> List[str]:
    ...
    if task_name in (
        ...
        for d in ds:
            ...
            if task_name in ("l1-universal-head", "l2-seed", "l2-mem-bench", "l1-candgen", "l3-graphlift", "l1-overlap-test", "encoder-graph"):   # dir-level skip misses this subdir on stale volumes
